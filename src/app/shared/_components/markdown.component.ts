...
@Component({
	...
	template: `
		<ng-container *ngIf="!!source">
			<markdown [src]="source" [lang]="activeLocale"></markdown>
		</ng-container>
	`,
	styles: ``,
	standalone: true,
	imports: [NgIf, NgxMarkdownComponent],
})
export class MarkdownComponent implements OnInit, OnDestroy {
	...
	ngOnInit(): void {
		if (!!this.locale) {
			...
			this.transloco.langChanges$.pipe(takeUntil(this.destroy$)).subscribe((locale: string) => {
