...
export const ROUTE_DATA_PRIVACY: RouteDesc = new RouteDesc({ id: 'data-privacy', path: 'datenskuul' }, allRoutesMap);
export const ROUTE_TERMS_OF_USE: RouteDesc = new RouteDesc({ id: 'terms-of-use', path: 'gebruuksbedingen' }, allRoutesMap); // Nutzungsbedingungen
export const ROUTE_IMPRINT: RouteDesc = new RouteDesc({ id: 'imprint', path: 'impressum' }, allRoutesMap);
